...
[`F.layer_norm`](https://max.modular.com/api/python/experimental.functional/#max.experimental.functional.layer_norm)
computes the normalization and applies the learned parameters in one call. The
weight is initialized with
[`Tensor.ones`](https://max.modular.com/api/python/generated/max.experimental.tensor.Tensor/#max.experimental.tensor.Tensor.ones)
and the bias with
[`Tensor.zeros`](https://max.modular.com/api/python/generated/max.experimental.tensor.Tensor/#max.experimental.tensor.Tensor.zeros):
