...
```python
{{#include ../../gpt2.py:stacking_transformer_blocks}}
```
...
**Next**: [Section 8](./step_08.md) adds the language model head that projects
these 768-dimensional hidden states to vocabulary logits.
